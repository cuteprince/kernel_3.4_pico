...
int Yushan_sensor_open_init(struct rawchip_sensor_init_data data)
{
	...
	uint32_t		udwIntrMask[] = {0x01E38E3B, 0xCC3C2C00, 0x001B7FFB};	
	...
	if (strcmp(data.sensor_name, "s5k3h2yx") == 0)
	{
		sDxoDopTuning.bSharpness = 0x70;
		sDxoDopTuning.bDenoisingLowGain = 0x75;
	...
	{
		sDxoDopTuning.bSharpness = 0x60;
		sDxoDopTuning.bDenoisingLowGain = 0x90;
		sDxoDopTuning.bDenoisingMedGain = 0x60;
		sDxoDopTuning.bDenoisingHiGain = 0x60;
	}
	else
	{
		sDxoDopTuning.bSharpness = 0x70;
		sDxoDopTuning.bDenoisingLowGain = 0x75;
		sDxoDopTuning.bDenoisingMedGain = 0x75;
		sDxoDopTuning.bDenoisingHiGain = 0x75;
	}

	sDxoDopTuning.bNoiseVsDetailsLowGain = 0x90;
